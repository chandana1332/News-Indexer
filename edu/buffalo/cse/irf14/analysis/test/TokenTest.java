...
public class TokenTest {
	...
	public final void setup() throws TokenizerException {
		...
		stream = tknizer
				.consume("test string with a lot of tokens that we are just going to keep testing on");
	}
	...
	public final void testMultiMerge() throws Exception {
		...
		assertNotNull(tgt);
		assertEquals(
				"test string with a lot of tokens that we are just going to keep testing on",
				tgt.toString());
	}
	...
	private static void invokeMerge(Token dest, Token... targets)
			throws Exception {
