...
public class TokenizerTest {
	...
	/**
	 * Test method for
	 * {@link edu.buffalo.cse.irf14.analysis.Tokenizer#consume(java.lang.String)}
	 * .
	 */
	@Test
	...
	public final void testMultipleTokens() {
		try {
			...
			assertArrayEquals(new String[] { "This", "is", "a", "longer",
					"test" }, serializeStream(ts));
	...
	public final void testMultipleTokensWithMultipleDelims() {
		try {
			TokenStream ts = spaceTknizer
					.consume("   This    is  a     longer     test    ");
			assertArrayEquals(new String[] { "This", "is", "a", "longer",
					"test" }, serializeStream(ts));
